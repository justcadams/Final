...
?>
<article class="center" id="april">
<h1>Menu</h1>
<h2 class="bold">Full catering large and small</h2>
<h3 class="bold">Call or order online to view the menu and pricing!</h3>
...
<h3>Soups</h3>
<p>Made fresh daily!<br>
Call to find out our specials.</p>
...
<p class="inline">Genoa Hard Salami, Fresh mozzarella Cheese, Tomato, Garlic, Sauteed Spinach, Basil Pesto Aioli on Ciabatta Bread.</p>
<h4 class="bold">The Cuban</h4>
<p class="inline">Provolone Cheese, Ham, Pulled Pork, Pickles, Yellow Mustard.</p>
<h4 class="bold">Roast Beef</h4>
<p class="inline">Roast Beef, Horseradish Mayonnaise, Roasted Red Peppers, Cabot Cheddar Cheese.</p>
<h4 class="bold">Turkey Bacon</h4>
<p class="inline">Turkey, Bacon, Cheddar Cheese, Tomato, Chipotle Mayonnaise.</p>
<h4 class="bold">Rachel</h4>
<p class="inline">Turkey, Sauerkraut, Swiss Cheese, Thousand Island Dressing.</p>
<h4 class="bold">Passionate Pig <p class="inline">+$1.00</p></h4>
<p class="inline">Pulled pork, Black Forest Ham, Jalapeno Bacon, Smoked Gouda, Fire Roasted Jalapeno Garlic Aioli.</p>
<h4 class="bold">Basil Pesto Panini</h4>
<p class="inline">Fresh Mozzarella, Tomato, Baby Spinach, Basil Pest on Panini Flat Bread.</p>
<h4 class="bold">Tasty Italian Panini</h4>
<p class="inline">McKenzie Black Forest Ham, Genoa Salami, Hot Capicola, Provolone Cheese, Red Onion, Banana Pepper, Black Olive, House Made Italian Oil, and Mayonnaise on a Sub Roll.</p>
</article>
